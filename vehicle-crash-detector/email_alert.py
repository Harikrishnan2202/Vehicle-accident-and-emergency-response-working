...
class Email:
    ...
    def email_conn(self):
        ...
        self.smtp.login('harisubramani22@gmail.com', 'lbuijwuttpecngkx')
    ...
    def run_mail(self):
        ...
        self.send_email(hospital_message, self.location, "720822108021@hit.edu.in",vcd_reference_code)
        self.send_email(police_message, self.location, "720822108021@hit.edu.in",vcd_reference_code)
        self.send_email(rto_message, self.location, "720822108021@hit.edu.in",vcd_reference_code)
        self.quit_conn()
